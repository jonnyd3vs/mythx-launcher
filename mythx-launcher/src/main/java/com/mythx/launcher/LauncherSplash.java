...
public class LauncherSplash extends JFrame {
    ...
    // MythX Purple Color Scheme (matching wrapper and launcher)
    ...
    public void start() {
        ...
        progressBar.setUI(new javax.swing.plaf.basic.BasicProgressBarUI() {
            ...
            protected void paintIndeterminate(Graphics g, JComponent c) {
                ...
                int boxX = (int) ((System.currentTimeMillis() / 10) % (width + boxWidth)) - boxWidth;

                GradientPaint gradient = new GradientPaint(boxX, 0, ACCENT_PRIMARY, boxX + boxWidth, 0, ACCENT_SECONDARY);
                g2.setPaint(gradient);
                g2.setClip(new RoundRectangle2D.Double(0, 0, width, height, height, height));
                g2.fillRoundRect(boxX, 0, boxWidth, height, height, height);
        ...
        // Start animation timer for indeterminate progress
        Timer animTimer = new Timer(50, e -> progressBar.repaint());
        animTimer.start();
    }
